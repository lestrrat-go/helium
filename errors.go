...
var (
	...
	// fatal error (libxml2 XML_ERR_UNKNOWN_VERSION). A version of the form "1.x"
	// other than "1.0" is NOT fatal — it is reported as a warning and parsing
	// continues, matching libxml2's XML_WAR_UNKNOWN_VERSION.
