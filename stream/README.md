...
The `stream` package writes XML directly to an `io.Writer` without building a
DOM.

Import path: `github.com/lestrrat-go/helium/stream`

<!-- INCLUDE(examples/stream_basic_example_test.go) -->
```go
