...
* W3C conformance suites: ~22,250 / 22,744 QT3 tests pass for XPath 3.1; ~11,780 / 13,129 W3C tests pass for XSLT 3.0 (skips are XSLT 1.0/2.0 backwards compatibility and other out-of-scope features); XSD 1.0 (the default) passes 14,271 / 14,399 (99.1%) of the W3C XML Schema Test Suite's schema-validity tests and 24,613 / 25,004 of its instance tests; XSD 1.1 passes the XSD-1.1-tagged portion of the same suite — 1,049 test cases from the IBM, Saxon, Oracle, and W3C-WG collections, 0 failures. Committed evidence (stamped summaries + JUnit) sits beside each package — `xsd/summary-xsd10.md`, `xsd/summary-xsd11.md`, `xslt3/summary-xslt30.md`, and the matching `results-*.xml`.
