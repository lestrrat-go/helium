...
The `xpointer` package evaluates XPointer fragment identifiers against helium
documents.

Import path: `github.com/lestrrat-go/helium/xpointer`

<!-- INCLUDE(examples/xpointer_evaluate_example_test.go) -->
```go
