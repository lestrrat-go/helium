...
The `catalog` package loads and resolves OASIS XML Catalogs for public IDs,
system IDs, and URIs.

Import path: `github.com/lestrrat-go/helium/catalog`

<!-- INCLUDE(examples/catalog_load_example_test.go) -->
```go
