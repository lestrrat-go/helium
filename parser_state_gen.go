// Code generated by "stringer -type=parserState -output parser_state_gen.go"; DO NOT EDIT.
...
func (i parserState) String() string {
	idx := int(i) - -1
	if i < -1 || idx >= len(_parserState_index)-1 {
		return "parserState(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _parserState_name[_parserState_index[idx]:_parserState_index[idx+1]]
}
