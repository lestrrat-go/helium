...
func TestMaxNodeContentSize(t *testing.T) {
	...
	t.Run("character data", func(t *testing.T) {
		...
		for _, kind := range kinds {
			t.Run("an oversized run fails with ErrNodeContentTooLarge ("+kind+")", func(t *testing.T) {
				t.Parallel()
			...
			t.Run("a within-cap run parses fine ("+kind+")", func(t *testing.T) {
				t.Parallel()
			...
			t.Run("a negative limit disables the cap ("+kind+")", func(t *testing.T) {
				t.Parallel()
			...
			t.Run("a raised cap admits a larger run ("+kind+")", func(t *testing.T) {
				t.Parallel()
	...
	t.Run("an attribute value", func(t *testing.T) {
		...
		for kind, mk := range bodies {
			t.Run("an oversized attribute value fails with ErrNodeContentTooLarge ("+kind+")", func(t *testing.T) {
				t.Parallel()
				_, err := helium.NewParser().
					MaxNodeContentSize(64).
			...
			t.Run("a within-cap attribute value parses fine ("+kind+")", func(t *testing.T) {
				t.Parallel()
				d, err := helium.NewParser().
					MaxNodeContentSize(64).
