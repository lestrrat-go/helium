...
// Code generated from WHATWG HTML5 Named Character References
...
// htmlLegacyEntities is the set of 106 entities that can be resolved
// without a trailing semicolon (HTML4 legacy behavior).
// These are entities that have both &Name and &Name; forms in the WHATWG spec.
var htmlLegacyEntities = map[string]bool{
	"AElig": true,
	"AMP": true,
	"Aacute": true,
	"Acirc": true,
...
// isLegacyEntity returns true if the entity can be resolved without a trailing
// semicolon (HTML4 legacy behavior). HTML5-only entities require a semicolon.
func isLegacyEntity(name string) bool {
	return htmlLegacyEntities[name]
}
