...
func (m *MyMarshalerTest) MarshalXML(e *stdxml.Encoder, start stdxml.StartElement) error {
	e.EncodeToken(start)
	e.EncodeToken(stdxml.CharData([]byte("hello world")))
	e.EncodeToken(stdxml.EndElement{Name: start.Name})
	return nil
}
...
func TestMarshalStdlib(t *testing.T) {
	...
	marshalSkipSet := map[int]string{
		...
		64:  "shim: embedded field path conflict resolution differs",
		65:  "shim: embedded struct omitempty handling differs",
		68:  "shim: XMLName precedence (value vs tag) differs",
		70:  "shim: xml.Name field as element content not handled",
		72:  "shim: xml.Name field as element content not handled",
		...
		102: "shim: CDATA ]]> splitting not implemented",
		...
		130: "shim: nil interface chardata not omitted",
		141: "shim: nil interface cdata not omitted",
		151: "shim: nil interface innerxml not omitted",
		162: "shim: nil interface element not omitted",
		...
		181: "shim: nil interface in any field not omitted",
		183: "shim: any-tagged field uses type name instead of field name for element",
		184: "shim: any-tagged field uses type name instead of field name for element",
	}
...
func TestUnmarshalStdlib(t *testing.T) {
	unmarshalSkipSet := map[int]string{
		...
		64:  "shim: embedded field path conflict resolution (FieldA>A1 vs FieldA) differs",
		65:  "shim: embedded struct pointer allocated when should remain nil (omitempty)",
		69:  "shim: XMLName tag precedence differs (InXMLNameTag not matched)",
		...
		115: "shim: indirect comment pointer allocated when no comment present",
		116: "shim: indirect comment pointer value incorrect",
		118: "shim: interface{} comment field not supported in unmarshal",
		119: "shim: interface{} comment field not supported in unmarshal",
		120: "shim: interface{} comment field not supported in unmarshal",
		127: "shim: interface{} chardata field error message differs",
		128: "shim: interface{} chardata field error message differs",
		129: "shim: interface{} chardata field error message differs",
		130: "shim: interface{} chardata field error message differs",
		138: "shim: interface{} cdata field error message differs",
		139: "shim: interface{} cdata field error message differs",
		140: "shim: interface{} cdata field error message differs",
		141: "shim: interface{} cdata field error message differs",
		147: "shim: indirect innerxml pointer allocated when no content",
		148: "shim: indirect innerxml pointer value incorrect",
		150: "shim: interface{} innerxml field not supported in unmarshal",
		151: "shim: interface{} innerxml field not supported in unmarshal",
		152: "shim: interface{} innerxml field not supported in unmarshal",
		...
		161: "shim: interface{} element field not supported in unmarshal",
		171: "shim: interface{} omitempty field not supported in unmarshal",
		176: "shim: indirect any pointer value differs",
		178: "shim: indirect any pointer allocated when no content",
		180: "shim: interface{} any field not supported in unmarshal",
		181: "shim: interface{} any field not supported in unmarshal",
		182: "shim: interface{} any field not supported in unmarshal",
		...
		188: "shim: interface{} any (renamed) field not supported in unmarshal",
		189: "shim: interface{} any (renamed) field not supported in unmarshal",
		190: "shim: interface{} any (renamed) field not supported in unmarshal",
