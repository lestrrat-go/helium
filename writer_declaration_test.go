...
func TestDeclaration(t *testing.T) {
	...
	// asserts that an invalid effective
	...
	t.Run("an invalid value emits nothing", func(t *testing.T) {
	...
	// asserts that an empty effective
	// encoding still omits the encoding pseudo-attribute (unchanged behavior) rather
	// than being rejected.
	t.Run("an empty encoding omits the pseudo-attribute", func(t *testing.T) {
	...
	// asserts that an effective XML version
	...
	// asserts that a malformed effective
	...
	t.Run("encoding injection rejected", func(t *testing.T) {
	...
	// asserts that a non-empty OutputVersion
	...
	t.Run("output version validated for a fragment", func(t *testing.T) {
