...
- Subcommands: `lint`, `xpath`, `xsd validate`
...
- Files: `main.go`, `lint.go`, `xpath.go`, `xsd_validate.go`
- Imports: helium, c14n/, xsd/, xinclude/, xpath1/, xpath3/, catalog/, internal/cliutil/
