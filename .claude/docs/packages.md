...
- Adaptive serialization delegates a singleton element/document item to the XML method; a quoted string-like atomic delegates character-data processing to the Text method before adaptive quoting, including normalization and character maps.
