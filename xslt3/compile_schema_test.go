...
func TestImportSchema(t *testing.T) {
	...
	t.Run("malformed XML not masked by precompiled fallback", func(t *testing.T) {
		t.Parallel()
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" targetNamespace="` + isNS + `">
  <xs:element name="root" type="xs:string"/>`
	...
	t.Run("invalid XSD not masked by precompiled fallback", func(t *testing.T) {
		t.Parallel()
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema"
  ...
  <xs:element name="root" type="s:missing"/>
	...
	t.Run("missing complex type name not masked by precompiled fallback", func(t *testing.T) {
		t.Parallel()
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema"
  ...
  <xs:element name="root" type="xs:string"/>
	...
	t.Run("fetch miss falls back to precompiled", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("namespace mismatch falls back to precompiled", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("namespace mismatch without precompiled errors", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("opaque resolver error not masked by precompiled fallback", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("nested include absolute URL base", func(t *testing.T) {
...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="/">
	...
	t.Run("nested include absolute cross host", func(t *testing.T) {
		const baseURI = "https://example.com/style/main.xsl"
		const mainSchemaURI = "https://example.com/s/main.xsd"
...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="/">
	...
	t.Run("nested include file URI base", func(t *testing.T) {
...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="/">
	...
	// asked for it.
	t.Run("nested include mem URI base", func(t *testing.T) {
...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="/">
	...
	// spelling.
	t.Run("nested include subdir relative", func(t *testing.T) {
		const baseURI = "https://example.com/style/main.xsl"
		const mainSchemaURI = "https://example.com/s/main.xsd"
...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="/">
	...
	t.Run("XML base file URI base", func(t *testing.T) {
...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="/">
	...
	// placeholder.
	t.Run("file backed missing type is fatal", func(t *testing.T) {
		const baseURI = "https://example.com/style/main.xsl"
		const mainSchemaURI = "https://example.com/s/main.xsd"
...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="/">
	...
	t.Run("absolute opaque URI local base", func(t *testing.T) {
...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="/">
	...
	t.Run("nested include through resolver", func(t *testing.T) {
		const baseURI = "mem://stylesheets/main.xsl"
...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="/">
	...
	t.Run("nested include denied", func(t *testing.T) {
		const baseURI = "mem://stylesheets/main.xsl"
		const mainSchemaURI = "mem:/stylesheets/main.xsd"
...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="/">
	...
	t.Run("inline nested include through resolver", func(t *testing.T) {
		const baseURI = "mem://stylesheets/main.xsl"
		const partSchemaURI = "mem:/stylesheets/part.xsd"
	...
	t.Run("inline nested include default deny", func(t *testing.T) {
		const baseURI = "mem://stylesheets/main.xsl"
	...
	t.Run("inline nested include denied", func(t *testing.T) {
		const baseURI = "mem://stylesheets/main.xsl"
...
func TestSourceSchemaLocation(t *testing.T) {
...
func TestNestedInclude(t *testing.T) {
	...
	t.Run("resolver not found demoted", func(t *testing.T) {
	...
	t.Run("resolver permission fatal", func(t *testing.T) {
		err := compileBoundaryImport(t, nestedFailResolver{
			main:       boundaryMainXSD,
			failBase:   "missing.xsd",
	...
	t.Run("post open read fatal", func(t *testing.T) {
		err := compileBoundaryImport(t, nestedFailResolver{
			main:     boundaryMainXSD,
			failBase: "missing.xsd",
