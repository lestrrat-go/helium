...
func TestStylesheetConcurrent(t *testing.T) {
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/root">
	...
	t.Run("shared source non schema aware", func(t *testing.T) {
		const (
			goroutines = 50
			iterations = 25
		)
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/root">
	...
	t.Run("schema aware distinct sources", func(t *testing.T) {
		const (
			goroutines = 50
			iterations = 25
		)
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/root">
	...
	t.Run("shared source schema aware", func(t *testing.T) {
		const (
			goroutines = 50
			iterations = 25
		)
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/root">
	...
	t.Run("a schema-aware transform does not mutate the source", func(t *testing.T) {
		schema := compileSchemaString(t, `
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="root">
    <xs:complexType>
