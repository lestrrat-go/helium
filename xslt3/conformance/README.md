# XSLT 3.0 W3C conformance evidence

Committed, point-in-time evidence that helium passes the XSLT 3.0 W3C conformance
...
```sh
# in ../helium-w3c-tests, after: go run ./cmd/w3cgen fetch xslt30
go run ./cmd/w3ctest -no-system-out \
  -out ../helium/xslt3/conformance/results.xml \
  -summary ../helium/xslt3/conformance/summary.md \
