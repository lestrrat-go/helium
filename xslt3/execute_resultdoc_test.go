...
func TestResultDocument(t *testing.T) {
	...
	t.Run("duplicate URI canonical", func(t *testing.T) {
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("format AVT error propagates", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("format AVT error releases URI in try catch", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
    <xsl:try>
	...
	t.Run("duplicate relative vs absolute file URI", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("primary serialization AVT error no double primary", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
    <xsl:try>
	...
	t.Run("primary throwing body no double primary", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
    <xsl:try>
	...
	t.Run("secondary serialization AVT error no nested commit", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
    <xsl:try>
	...
	t.Run("primary validation strict serialization AVT error", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
    <xsl:try>
	...
	t.Run("primary type serialization AVT error", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
    <xsl:try>
	...
	t.Run("primary validation strict applies overrides", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("secondary base URI from output URI", func(t *testing.T) {
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	// form.)
	t.Run("duplicate absolute dot segments", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("nested duplicate relative vs absolute file URI", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("serialization AVT error propagates", func(t *testing.T) {
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("serialization AVT error observable in try catch", func(t *testing.T) {
		for _, tc := range []struct {
			name string
			attr string
		}{
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("primary output version AVT applied", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("primary JSON allow duplicate names AVT", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
	...
	t.Run("primary JSON allow duplicate names default output", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
	...
	t.Run("secondary JSON allow duplicate names default output", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="/">
	...
	t.Run("primary undeclare prefixes AVT", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("secondary resolving to principal URI collides", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("secondary absolute equal to principal URI collides", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("secondary distinct from principal URI succeeds", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("allow duplicate names invalid constant compile error", func(t *testing.T) {
		doc, err := helium.NewParser().Parse(t.Context(), []byte(`
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("allow duplicate names invalid AVT dynamic error", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:output method="json" allow-duplicate-names="yes"/>
  <xsl:template match="/">
	...
	t.Run("secondary JSON duplicate key rejected", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0"
                xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:map="http://www.w3.org/2005/xpath-functions/map">
  ...
  <xsl:template match="/">
	...
	t.Run("secondary JSON duplicate key allowed", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0"
                xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:map="http://www.w3.org/2005/xpath-functions/map">
  ...
  <xsl:template match="/">
	...
	t.Run("primary AVT only keeps HTML auto detect", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
	...
	t.Run("invalid boolean AVT raises SEPM0016", func(t *testing.T) {
		for _, tc := range []struct {
			name string
			attr string
		}{
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("build tree AVT evaluated", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("sole suppress indentation honored", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
	...
	t.Run("XHTML omit declaration false explicit", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
	...
	t.Run("primary adaptive preserves atomic items", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
	...
	t.Run("secondary validation fail rollback try catch", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
	...
	t.Run("secondary serialization error surfaces", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("primary adaptive markup temporary frames", func(t *testing.T) {
		tests := []struct {
			name       string
			output     string
			attributes string
...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="/">
	...
	t.Run("primary adaptive markup temporary frames with an invalid character", func(t *testing.T) {
		tests := []struct {
			name       string
			output     string
			attributes string
...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="/">
	...
	t.Run("primary result document unlinks children", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("a parameter document inherits the default output", func(t *testing.T) {
