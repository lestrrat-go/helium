...
var w3cImplicitSkips = map[string]string{
	...
	// seqtor: sequence constructor text node spacing and separator issues
	"seqtor-011": "sequence constructor text/atomic interleaving spacing incorrect",
	"seqtor-012": "sequence constructor text/atomic interleaving spacing incorrect",
	"seqtor-013": "sequence constructor text/atomic interleaving spacing incorrect",
	"seqtor-014": "sequence constructor text/atomic interleaving spacing incorrect",
	"seqtor-016": "sequence constructor text/atomic interleaving spacing incorrect",
	"seqtor-017": "sequence constructor text/atomic interleaving spacing incorrect",
	"seqtor-023": "empty atomic values not discarded in sequence constructor",
	"seqtor-025": "empty atomic values not discarded in sequence constructor",
	"seqtor-026": "empty atomic values not discarded in sequence constructor",
	"seqtor-030": "sequence constructor text/atomic interleaving spacing incorrect",
	"seqtor-032": "sequence constructor text/atomic interleaving spacing incorrect",
	"seqtor-033": "sequence constructor text/atomic interleaving spacing incorrect",
	"seqtor-036b": "comment content separator handling incorrect",
	"seqtor-036c": "comment content separator handling incorrect",
	"seqtor-036d": "comment content separator handling incorrect",
	"seqtor-037b": "PI content separator handling incorrect",
	"seqtor-037c": "PI content separator handling incorrect",
	"seqtor-037d": "PI content separator handling incorrect",
	"seqtor-041": "xsl:for-each over function items incorrect",
	"seqtor-043d": "TVT sequence of text nodes spacing incorrect",
	"seqtor-043f": "function-item type checking in sequence constructor incorrect",
