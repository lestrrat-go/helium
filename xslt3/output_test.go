...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/"><root>hello</root></xsl:template>
	...
	t.Run("XML omits writer terminators", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/"><root>hello</root></xsl:template>
	...
	t.Run("reports short write", func(t *testing.T) {
	...
	t.Run("XML preserves explicit trailing text newline", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/"><out/><xsl:text>&#10;</xsl:text></xsl:template>
	...
	t.Run("XML indentation discards whitespace only top level text", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/"><out/><xsl:text>&#10;</xsl:text></xsl:template>
	...
	t.Run("nil output def", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/"><root>hello</root></xsl:template>
</xsl:stylesheet>`)
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">hello world</xsl:template>
	...
	t.Run("does not mutate the output def", func(t *testing.T) {
	...
	t.Run("BOM reports short write", func(t *testing.T) {
	...
	t.Run("direct character map reports short write", func(t *testing.T) {
	...
	t.Run("HTML character map reports short write", func(t *testing.T) {
	...
	t.Run("JSON character map reports short write", func(t *testing.T) {
		doc := parseShortWriteDocument(t)
		outDef := &xslt3.OutputDef{
	...
	t.Run("XHTML reports short write", func(t *testing.T) {
		doc, err := helium.NewParser().Parse(t.Context(), []byte(`<root>alpha</root>`))
		require.NoError(t, err)
		includeContentType := false
		outDef := &xslt3.OutputDef{
	...
	t.Run("text reports short write", func(t *testing.T) {
		doc, err := helium.NewParser().Parse(t.Context(), []byte(`<root>alpha</root>`))
		require.NoError(t, err)
...
func TestAdaptiveOutput(t *testing.T) {
	...
	t.Run("primary adaptive comment and processing instruction", func(t *testing.T) {
		tests := []struct {
			name        string
			instruction string
			want        string
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">`+tt.instruction+`</xsl:template>
	...
	t.Run("primary adaptive comment and processing instruction sequence item separator", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
	...
	t.Run("primary adaptive markup then element keeps deferred separators", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:output method="adaptive" item-separator=" | "/>
  <xsl:template match="/">
	...
	t.Run("primary adaptive markup separator applies character map and normalization", func(t *testing.T) {
		decomposed := "e\u0301"
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
	...
	t.Run("secondary adaptive markup sequence item separator has no declaration", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("primary adaptive comment and processing instruction sequence item separator text fallback", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:output method="adaptive" item-separator=" | "/>
  <xsl:template match="/">
	...
	t.Run("primary adaptive comment and processing instruction invalid character", func(t *testing.T) {
		tests := []struct {
			name        string
			instruction string
		}{
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">`+tt.instruction+`</xsl:template>
	...
	t.Run("primary adaptive comment and processing instruction sequence item separator invalid character", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:output method="adaptive" item-separator=" | "/>
  <xsl:template match="/">
...
func TestSerializeItems(t *testing.T) {
	...
	t.Run("normalization with character map", func(t *testing.T) {
		decomposed := "e\u0301"
		composed := "é"
		replacement := "a\u030a"
	...
	t.Run("adaptive map key normalization with character map", func(t *testing.T) {
		decomposed := "e\u0301"
		composed := "é"
		replacement := "\"a\u030a"
	...
	t.Run("adaptive string normalization", func(t *testing.T) {
		decomposed := "e\u0301"
		composed := "é"
	...
	t.Run("adaptive singleton element normalization", func(t *testing.T) {
		decomposed := "e\u0301"
		composed := "é"
		tests := []struct {
			name    string
	...
	t.Run("adaptive fully normalized node character map", func(t *testing.T) {
		decomposed := "e\u0301"
		mappedNFC := "mapped&#xE9;"
	...
	t.Run("adaptive node character data transformations", func(t *testing.T) {
		decomposed := "e\u0301"
		replacement := "a\u030a"
		doc := helium.NewDefaultDocument()
	...
	t.Run("adaptive comment and processing instruction", func(t *testing.T) {
		decomposed := "e\u0301"
		data := "x" + decomposed
	...
	t.Run("adaptive comment and processing instruction invalid chars", func(t *testing.T) {
		tests := []struct {
			name  string
	...
	t.Run("XML invalid char", func(t *testing.T) {
	...
	t.Run("XHTML invalid char", func(t *testing.T) {
		root := newBadCharElement(t)
		items := xpath3.ItemSlice{xpath3.NodeItem{Node: root}}
	...
	t.Run("JSON node XML invalid char", func(t *testing.T) {
		root := newBadCharElement(t)
		items := xpath3.ItemSlice{xpath3.NodeItem{Node: root}}
		var buf bytes.Buffer
	...
	t.Run("adaptive invalid char", func(t *testing.T) {
		root := newBadCharElement(t)
	...
	t.Run("adaptive XML version", func(t *testing.T) {
		tests := []struct {
			name               string
		...
		for _, tt := range tests {
			for _, version := range versions {
				t.Run(tt.name+" "+version.name, func(t *testing.T) {
					var buf bytes.Buffer
	...
	t.Run("XML reports short write", func(t *testing.T) {
		doc := parseShortWriteDocument(t)
		separator := "||"
	...
	t.Run("adaptive reports short write", func(t *testing.T) {
		doc := parseShortWriteDocument(t)
		separator := "||"
		stringItem := func(s string) xpath3.AtomicValue {
			return xpath3.AtomicValue{TypeName: xpath3.TypeString, Value: s}
	...
	t.Run("JSON reports short write", func(t *testing.T) {
		doc := parseShortWriteDocument(t)
	...
	t.Run("JSON post processing reports short write", func(t *testing.T) {
	...
	t.Run("document items omit writer terminators", func(t *testing.T) {
...
func TestDefaultOutputDef(t *testing.T) {
	t.Run("the stylesheet default", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">hello</xsl:template>
	...
	t.Run("nil stylesheet", func(t *testing.T) {
...
func TestMessage(t *testing.T) {
	...
	t.Run("invalid char SERE0006", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
    <xsl:message select="/*"/>
	...
	t.Run("document preserves top level whitespace", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
...
func TestOutputDefIsolation(t *testing.T) {
	...
	t.Run("a resolved output def is a snapshot", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/"><out/></xsl:template>
	...
	t.Run("a result-document handler output def is isolated", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
	...
	t.Run("a primary result-document resolved output def is isolated", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:output method="xml" item-separator="|" build-tree="yes"/>
  <xsl:template match="/">
	...
	t.Run("a primary result-document boolean false overrides an inherited true", func(t *testing.T) {
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
	...
	t.Run("concurrent Serialize and ResolvedOutputDef", func(t *testing.T) {
		ss := compileStylesheetString(t, `
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:output method="xml" item-separator="|"/>
  <xsl:template match="/"><out/></xsl:template>
...
func TestCharacterMap(t *testing.T) {
	t.Run("a replacement skips normalization", func(t *testing.T) {
		decomposed := "e\u0301"
		composed := "é"
		doc, err := helium.NewParser().Parse(t.Context(), []byte("<out>x"+decomposed+"</out>"))
		require.NoError(t, err)
	...
	t.Run("normalization keeps raw disable-output-escaping content", func(t *testing.T) {
		doc := helium.NewDefaultDocument()
	...
	t.Run("normalization preserves raw disable-output-escaping markup", func(t *testing.T) {
		doc := helium.NewDefaultDocument()
		root, err := doc.CreateElement("out")
		require.NoError(t, err)
		require.NoError(t, doc.AddChild(root))
	...
	t.Run("text normalization crosses an omitted PI", func(t *testing.T) {
		composed := "é"
