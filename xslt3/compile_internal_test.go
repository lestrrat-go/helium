...
func TestSplitOriginID(t *testing.T) {
	...
	t.Run("unique across compiles", func(t *testing.T) {
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="a | b"/>
	...
	t.Run("distinct per union rule", func(t *testing.T) {
		const src = `<?xml version="1.0"?>
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
...
func TestFnStreamability(t *testing.T) {
	...
	t.Run("a prefixed fn: call at the XSLT layer", func(t *testing.T) {
	...
	t.Run("an EQName fn call at the XSLT layer", func(t *testing.T) {
