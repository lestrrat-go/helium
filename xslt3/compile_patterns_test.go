...
func TestPattern(t *testing.T) {
	...
	t.Run("predeclared function namespace", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"%s>
  <xsl:template match="%s"><out/></xsl:template>
	...
	t.Run("predeclared function matches at runtime", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="` + tc.match + `">[matched]</xsl:template>
	...
	t.Run("XSLT function allowed", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="a">[plain]</xsl:template>
	...
	// runtime.
	t.Run("unprefixed function validation", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="%s"><out/></xsl:template>
	...
	t.Run("forbidden function respects explicit binding", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="a[current-group()]"><out/></xsl:template>
	...
	t.Run("forbidden function EQName", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="a[Q{` + fnNS + `}` + fn + `()]"><out/></xsl:template>
	...
	t.Run("lexical namespace snapshot", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="a[math:pi() > 3]" xmlns:math="urn:x">[matched]</xsl:template>
	...
	// otherwise.
	t.Run("default namespace not element default", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xpath-default-namespace="urn:x">
  ...
  <xsl:template match="a"><xsl:text>[matched]</xsl:text></xsl:template>
	...
	// local name alone.
	t.Run("element kind test namespace", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="*"/>
	...
	t.Run("XPath default namespace empty resets", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xpath-default-namespace="urn:x">
  ...
  <xsl:template match="*"/>
	...
	t.Run("attribute kind test EQName", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="@*"/>
	...
	t.Run("attribute kind test not governed by default NS", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:p="urn:x" xpath-default-namespace="urn:y">
  ...
  <xsl:template match="@*"/>
	...
	t.Run("schema element test uses pattern snapshot", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:p="urn:global">
  ...
  <xsl:template match="*"/>
	...
	// accepted.
	t.Run("start function requires fn namespace", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="%s"><out/></xsl:template>
	...
	t.Run("fn:current() compiles", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="a[fn:current()]">[matched]</xsl:template>
	...
	t.Run("a key match honors the local xpath-default-namespace", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/"><out><xsl:value-of select="count(key('k','1'))"/></out></xsl:template>
	...
	t.Run("a typed strict pattern with a predeclared prefix", func(t *testing.T) {
		t.Parallel()
