...
func TestSerializeWriterErrors(t *testing.T) {
	...
	t.Run("serializeNodeWithMethod propagates a writer error", func(t *testing.T) {
	...
	t.Run("serializeItemJSON propagates a node serialization error", func(t *testing.T) {
		el := invalidNameElement(t)
	...
	t.Run("serializeMessageSequence propagates a writer error", func(t *testing.T) {
		el := invalidNameElement(t)
