...
// TestAnnotateAttrRegistersIDSubtype verifies that attributes whose type is
// a user-defined restriction of xs:ID are recognised by the id() function
// during an XSLT transform with xsl:import-schema.
