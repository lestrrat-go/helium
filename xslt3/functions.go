...
func (ec *execContext) xsltFunctions() map[string]xpath3.Function {
	...
	ec.cachedFns = map[string]xpath3.Function{
		...
		fnSystemProperty:            &xsltFunc{min: 1, max: 1, fn: ec.fnSystemProperty},
		...
		fnSnapshot:                  &xsltFunc{min: 0, max: 1, fn: ec.fnSnapshot},
		"regex-group":               &regexGroupFunc{ec: ec},
		"transform":                 &xsltFunc{min: 1, max: 1, fn: ec.fnTransform},
		fnAvailableSystemProperties: &xsltFunc{min: 0, max: 0, fn: ec.fnAvailableSystemProperties},
