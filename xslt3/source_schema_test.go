...
func TestSourceSchema(t *testing.T) {
	...
	t.Run("load malformed XML fatal under lax", func(t *testing.T) {
		ctx := t.Context()
	...
	t.Run("load invalid XSD fatal under lax", func(t *testing.T) {
		ctx := t.Context()
		ss := compileTaxSheet(t)
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <xs:element name="a" type="xs:string"/>
	...
	// benign fetch miss.
	t.Run("load policy denial fatal under lax", func(t *testing.T) {
		ctx := t.Context()
		ss := compileTaxSheet(t)
	...
	t.Run("load fetch miss skipped under lax", func(t *testing.T) {
		ctx := t.Context()
		ss := compileTaxSheet(t)
	...
	t.Run("post open read fail fatal under lax", func(t *testing.T) {
		ctx := t.Context()
		ss := compileTaxSheet(t)
	...
	// not a benign miss.
	t.Run("HTTP403 fatal under lax", func(t *testing.T) {
	...
	t.Run("HTTP500 fatal under lax", func(t *testing.T) {
	...
	t.Run("HTTP404 skipped under lax", func(t *testing.T) {
		ctx := t.Context()
...
<doc xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	...
	t.Run("strict fatal on miss", func(t *testing.T) {
		ctx := t.Context()
	...
	t.Run("opaque resolver error fatal under lax", func(t *testing.T) {
		ctx := t.Context()
		ss := compileTaxSheet(t)
	...
	t.Run("multi entry later malformed fatal", func(t *testing.T) {
		ctx := t.Context()
		ss := compileTaxSheet(t)
	...
	t.Run("multi entry later invalid XSD fatal", func(t *testing.T) {
		ctx := t.Context()
		ss := compileTaxSheet(t)
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <xs:element name="a" type="xs:string"/>
	...
	t.Run("multi entry later valid loads", func(t *testing.T) {
		ctx := t.Context()
		ss := compileTaxSheet(t)
