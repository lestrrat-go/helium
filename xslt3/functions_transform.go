...
func (ec *execContext) xsltFunctionsNS() map[xpath3.QualifiedName]xpath3.Function {
	...
	ec.cachedFnsNS[xpath3.QualifiedName{URI: xpath3.NSFn, Name: fnSystemProperty}] =
		&xsltFunc{min: 1, max: 1, fn: ec.fnSystemProperty}
	ec.cachedFnsNS[xpath3.QualifiedName{URI: xpath3.NSFn, Name: fnAvailableSystemProperties}] =
	...
	ec.cachedFnsNS[xpath3.QualifiedName{URI: xpath3.NSFn, Name: fnSnapshot}] =
