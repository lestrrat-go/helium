...
func TestResourceBudget(t *testing.T) {
	...
	t.Run("cancellation honored", func(t *testing.T) {
		tests := []struct {
			name  string
			xsl   string
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("max resource bytes doc", func(t *testing.T) {
	...
	t.Run("max resource bytes source document", func(t *testing.T) {
		const limitBytes = int64(1024)
	...
	// the stream.
	t.Run("max resource bytes unparsed text", func(t *testing.T) {
		const limitBytes = int64(1024)
	...
	t.Run("analyze string match cap", func(t *testing.T) {
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("default deny hostile doc", func(t *testing.T) {
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("default deny hostile unparsed text", func(t *testing.T) {
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	t.Run("result document fanout cancellation", func(t *testing.T) {
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
	...
	// ordinary error.
	t.Run("unbounded recursion is bounded", func(t *testing.T) {
...
func TestResourceCapPropagation(t *testing.T) {
	...
	t.Run("a simplified stylesheet honors the compiler cap", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("a use-package nested include honors the cap", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("an fn:transform nested compile honors the invocation cap", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("an over-cap source document preserves the sentinel", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("an over-cap merge preserves the sentinel", func(t *testing.T) {
		t.Parallel()
	...
	// errors.Is it.
	t.Run("an over-cap nested schema import is fatal", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="/">
	...
	t.Run("an over-cap schema import is not masked by the precompiled fallback", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="/"><out/></xsl:template>
	...
	t.Run("a missing resolver is not masked by the precompiled fallback", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="/"><out/></xsl:template>
	...
	// PASSES after.)
	t.Run("a nested path escape is not masked by the precompiled fallback", func(t *testing.T) {
		t.Parallel()
...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="/"><out/></xsl:template>
	...
	t.Run("an over-cap parameter document preserves the sentinel", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("an over-cap result-document parameter document is fatal", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("an over-cap source-schema location is fatal", func(t *testing.T) {
		t.Parallel()
