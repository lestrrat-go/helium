...
func TestDecryptNamespace(t *testing.T) {
	...
	t.Run("content in-scope ancestor namespace", func(t *testing.T) {
	...
	t.Run("content parent default namespace", func(t *testing.T) {
		sessionKey := make([]byte, 32)
		_, err := rand.Read(sessionKey)
		require.NoError(t, err)
	...
	t.Run("content detached no shadowing", func(t *testing.T) {
		sessionKey := make([]byte, 32)
		_, err := rand.Read(sessionKey)
		require.NoError(t, err)
	...
	t.Run("element ancestor namespace round-trip", func(t *testing.T) {
	...
	t.Run("element detached no shadowing", func(t *testing.T) {
		sessionKey := make([]byte, 32)
		_, err := rand.Read(sessionKey)
		require.NoError(t, err)
	...
	t.Run("content prefix on parent ancestor", func(t *testing.T) {
		sessionKey := make([]byte, 32)
		_, err := rand.Read(sessionKey)
		require.NoError(t, err)
